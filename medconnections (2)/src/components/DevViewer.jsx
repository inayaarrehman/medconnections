...
import connectionBank, { validateBankCategory, DIFFICULTY_TIERS, BANK_STATUS } from '../data/connectionBank.js'
  ...
  return (
    <div className="dev-detail">
      <div className="dev-detail-meta">
        ...
        <span>
          <strong>Systems:</strong> {(category.systems || []).join(', ') || '—'}
        </span>
        <span>
...
export default function DevViewer() {
  const [tab, setTab] = useState('puzzles') // 'puzzles' | 'bank'
      ...
      {tab === 'bank' && (
        <>
          <p className="section-sub">
            ...
            generation or the Daily Puzzle.
          </p>
